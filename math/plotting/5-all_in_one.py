...
Plots multiple graphs in one figure using subplots.
"""
import numpy as np
...
def all_in_one():
    """
    Plot the first 5 tasks in one figure arranged in a 3x2 grid.
    """
    y0 = np.arange(0, 11) ** 3
    ...
    # 4: frequency histogram (bins=10, range=(0,100))
